"""Streamlit app for FOIArchive Corpus"""
...
archive = "NATO"
archive_description = "NATO Archive description goes here"
st.set_page_config(page_title=f'{archive} FOIArchive Corpus GUI')
st.title(f'{archive} FOIArchive GUI')
archive_description
